 ...
 * @param {number} [buffer         = step * 0.1] - The minimum distance required between X positions to avoid overlap.
...
export function getNonOverlappingX(
    z, baseX, buffer = step * 0.3, maxAttempts = 30, numOffsetTypes = 4
) {
